...
namespace Demo.Infra.Repository
{
        ...
        , IResearchRepository
    {
        ...
        public async Task<IEnumerable<Research>> GetFilteredResearches(FilterObjectDto filter)
        {
        ...
        public async Task<IEnumerable<FilteredResearchGroupedDto>> GetFilteredResearchesGrouped(FilterObjectDto filter)
        {
            ...
            var groupedResponse = nonGroupedResponse.AsEnumerable()
                    ...
                    }).Select(s => new FilteredResearchGroupedDto
                    {
