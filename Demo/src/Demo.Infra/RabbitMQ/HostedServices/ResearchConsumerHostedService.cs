...
namespace Demo.Infra.RabbitMQ.HostedServices
{
    ...
    public class ResearchConsumerHostedService : BackgroundService
    {
        ...
        private void InitRabbitMQ()
        {
            ...
            _channel.ExchangeDeclare("researches.exchange", ExchangeType.Topic);
            _channel.QueueDeclare("researches.queue", false, false, false, null);
            _channel.QueueBind("researches.queue", "researches.exchange", "researches.queue*", null);
        ...
        protected override Task ExecuteAsync(CancellationToken stoppingToken)
        {
            ...
            _channel.BasicConsume("researches.queue", false, consumer);
        ...
        private void HandleMessage(string content)
        {
            ...
            _repositoryResearch.AddAsync(research);
        }
